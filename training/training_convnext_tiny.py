...
### 2. `train_densenet201.py`

Create:

`training/train_densenet201.py`

The code is the same structure. The important model change is:
...
```python
plt.savefig("densenet201_loss_curve.png", dpi=300)
```

```python
plt.savefig("densenet201_accuracy_curve.png", dpi=300)
```

If you want the **complete copy-paste file**, I recommend we do it that way rather than you manually changing the ConvNeXt file.
...
Use the same training code, with the model:
